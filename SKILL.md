...
| `scientific` | 科学计数法数字 | LaTeX，指数无花括号 | `1.5×10³`→`$1.5 \times 10^3$`，`2.8×10^{3}`→`$2.8 \times 10^{3}$` |
...
| 科学计数法数字（`1.5×10³`、`2.8×10^{3}`） | 整体进 LaTeX，指数无花括号（`$1.5 \times 10^3$`、`$2.8 \times 10^{3}$`） |
...
| 1.5×10³、2.8×10^{3} | $1.5 \times 10^3$、$2.8 \times 10^{3}$（科学计数法整体进 LaTeX） |
